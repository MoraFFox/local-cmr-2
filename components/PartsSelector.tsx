  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-slate-950/50 border border-slate-800 rounded-2xl p-4 md:p-6">
        <h3 className="text-xs font-bold uppercase tracking-widest text-slate-500 mb-4">Replacements Inventory</h3>
        ...
        {filteredOptions.length > 0 ? (
          <div className="space-y-8">
            ...
            {regularParts.length > 0 && (
                <section>
                    <h4 className="text-sm font-semibold text-slate-500/80 mb-3 border-b border-slate-700 pb-2">
                        All Parts
                    </h4>
                    <div className={`${viewMode === 'grid' ? 'grid grid-cols-1 sm:grid-cols-2 gap-3' : 'flex flex-col gap-2'}`}>
