              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-3 bg-cream dark:bg-espresso-light text-ink dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-copper-500 border ${
                ...
                <div className="relative">
                  ...
                  {clientBaristas && clientBaristas.length > 0 ? (
                    <select
                      ...
                      onChange={handleFieldChange}
                      className="w-full pl-10 pr-4 py-3 bg-cream dark:bg-espresso-light text-ink dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-copper-500 border border-hairline dark:border-hairline"
                    >
                  ...
                  {[1, 2, 3, 4, 5].map((star) => (
                    ...
                    >
                      {star <= (editedRecord.visitRating || 0) ? (
                        ...
                        <StarIcon className="w-8 h-8 text-latte/70 dark:text-ink" />
                      )}
                    </button>
                  ))}
                </div>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="flex items-center gap-3">
              <input
                ...
                onChange={handleFieldChange}
                className="w-5 h-5 text-copper-600 rounded focus:ring-copper-500"
              />
                  ...
                  <button
                    ...
                    className={`
                      ...
                      ${editedRecord.paidBy === 'company'
                        ? 'border-copper-500 bg-cream-2 dark:bg-copper-500/10 text-copper-900 dark:text-copper-300'
        ...
        {expandedSections.has('supervisor') && (
          <div className="p-6 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-cream dark:bg-espresso-light text-ink dark:text-white rounded-lg border border-hairline dark:border-hairline focus:outline-none focus:ring-2 focus:ring-copper-500"
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 text-copper-600 dark:text-copper-400 font-medium hover:bg-cream-2 dark:hover:bg-copper-500/10 rounded-lg border border-copper-500/30 dark:border-copper-700 transition-colors"
            >
          ...
          <div className="p-6 space-y-4">
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 bg-cream dark:bg-espresso-light text-ink dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-copper-500 border border-hairline dark:border-hairline resize-none"
              />
            </div>
      ...
      <div className="bg-cream dark:bg-espresso rounded-xl border border-hairline dark:border-hairline overflow-hidden">
        <SectionHeader
          ...
          badge={editedRecord.photos && editedRecord.photos.length > 0 && (
            <span className="px-2 py-0.5 bg-copper-500/10 dark:bg-copper-500/10 text-copper-700 dark:text-copper-400 text-xs rounded-full">
        ...
        {expandedSections.has('photos') && (
          <div className="p-6 space-y-6">
            ...
            {uploadingPhotos && (
              <div className="flex items-center gap-3 p-4 bg-cream-2 dark:bg-copper-500/10 rounded-lg border border-copper-500/30 dark:border-copper-500/30">
                <svg className="animate-spin w-5 h-5 text-copper-500" fill="none" viewBox="0 0 24 24">
                  <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                  <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                </svg>
                <span className="text-copper-700 dark:text-copper-400 font-medium">Uploading photos...</span>
              </div>
            )}
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <label className={`flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-lg cursor-pointer transition-colors ${
                  uploadingPhotos 
                    ...
                    : 'bg-cream-2 dark:bg-copper-500/10 text-copper-600 dark:text-copper-400 hover:bg-copper-500/10 dark:hover:bg-copper-500/10 border border-copper-500/30 dark:border-copper-500/30'
                }`}>
