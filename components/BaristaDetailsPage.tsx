  ...
  return (
    <div className='w-full max-w-7xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500'>
      ...
      <div className='flex items-center gap-4'>
        <button
          onClick={onBack}
          className='p-2 rounded-full bg-cream dark:bg-espresso-light shadow-sm border border-hairline text-ink dark:text-latte/70 hover:text-copper-600 dark:hover:text-copper-400 transition-colors'
        >
          ...
          <div className='flex-grow space-y-4'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 pt-4 border-t border-hairline'>
              ...
              <div>
                ...
                <p className='font-mono font-bold text-copper-600 dark:text-copper-400'>
      ...
      <div className='bg-cream dark:bg-espresso-light rounded-2xl shadow-lg border border-hairline overflow-hidden'>
        <div className='p-6 border-b border-hairline flex flex-col lg:flex-row lg:items-center justify-between gap-4'>
          <h3 className='text-lg font-bold text-ink dark:text-white flex items-center gap-2'>
            <WrenchScrewdriverIcon className='w-5 h-5 text-copper-500' />
          ...
          <div className='flex flex-wrap items-center gap-3'>
            <div className='relative'>
              ...
              <input
                ...
                className='pl-9 pr-3 py-1.5 text-xs rounded-full border-hairline bg-slate-50 dark:bg-slate-900 text-ink dark:text-white focus:ring-copper-500 focus:border-copper-500'
              />
            </div>
            <select
              value={filterClient}
              onChange={(e) => setFilterClient(e.target.value)}
              className='text-xs rounded-full border-hairline bg-slate-50 dark:bg-slate-900 text-ink dark:text-latte/70 py-1.5 focus:ring-copper-500'
            >
                  ...
                  >
                    ...
                    <td className='px-6 py-4 text-right'>
                      <button
                        ...
                        className='text-latte group-hover:text-copper-600 transition-colors p-2 rounded-full hover:bg-cream-2 dark:hover:bg-copper-500/10'
                        title='View Details'
                      >
                  ...
                  <section>
                    ...
                    <div className='flex flex-wrap gap-2'>
                      {selectedRecord.machines.map((m, i) => (
                        ...
                        >
                          <WrenchScrewdriverIcon className='w-4 h-4 text-copper-500' />
                      ...
                      <ul className='space-y-2'>
                        {selectedRecord.servicesPerformed.map((s, i) => (
                          ...
                          >
                            ...
                            <span className='text-xs font-bold text-copper-600'>
                              x{s.count}
                            </span>
                          </li>
                        ))}
