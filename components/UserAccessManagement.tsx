...
const UserAccessManagement: React.FC = () => {
  ...
  const getRoleBadge = (role: InviteRole) => {
    switch (role) {
      ...
      case 'technician':
        return (
          <span className="inline-flex items-center rounded-full bg-cream-2 dark:bg-primary/20 px-2.5 py-0.5 text-xs font-medium text-primary dark:text-primary/80">
            {t.technician}
          </span>
        );
      default:
