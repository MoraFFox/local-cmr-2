  ...
  return (
    <div className={className}>
      ...
      <div className="relative group focus-within:text-brand-red">
        {icon && (
          <div className="absolute inset-y-0 right-0 pr-3.5 flex items-center pointer-events-none text-secondary group-focus-within:text-brand-red transition-colors">
