      ...
      <section>
        ...
        formData.branches.every((b) => b.maintenanceHistory.length === 0) ? (
          ...
          <>
            ...
            <div className="mt-4 p-4 rounded-lg bg-cream-2/50 dark:bg-primary/10">
                ...
                <dd className="mt-1 text-ink sm:col-span-2 sm:mt-0 flex justify-between items-center">
                  ...
                  {totalMaintenanceCost > 0 && (
                    <button
                      ...
                      className="text-sm font-semibold text-primary hover:text-primary transition-colors transform active:scale-95"
                    >
                      View Details
                    </button>
                  )}
