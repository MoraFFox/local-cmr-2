        ...
        {toasts.map((toast) => (
          <div
            ...
            className={`px-4 py-3 rounded-lg shadow-lg flex items-center gap-3 min-w-[300px] max-w-[500px] animate-toast-slide-in border ${
              toast.type === 'success'
                ? 'bg-surface-elevated text-primary border-default/50'
                : toast.type === 'error'
          ...
          >
            ...
            <button
              ...
              className="flex-shrink-0 p-1 rounded hover:bg-ink/10 transition-colors text-secondary hover:text-primary"
              aria-label="إغلاق"
            >
