        ...
        {toasts.map((toast) => (
          <div
            ...
            className={`px-4 py-3 rounded-lg shadow-lg flex items-center gap-3 min-w-[300px] max-w-[500px] animate-toast-slide-in border ${
              toast.type === 'success'
                ...
                : toast.type === 'warning'
                ? 'bg-cream text-ink border-copper-500/30'
          ...
          >
            ...
            <div className="flex-shrink-0">
              ...
              {toast.type === 'warning' && (
                <svg className="w-5 h-5 text-copper-500" fill="currentColor" viewBox="0 0 20 20">
            ...
            <button
              ...
              className="flex-shrink-0 p-1 rounded hover:bg-ink/10 transition-colors text-latte hover:text-ink"
              aria-label="إغلاق"
            >
