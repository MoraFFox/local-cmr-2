        ...
        {toasts.map((toast) => (
          <div
            ...
            className={`px-4 py-3 rounded-lg shadow-lg flex items-center gap-3 min-w-[300px] max-w-[500px] animate-toast-slide-in border ${
              toast.type === 'success'
                ? 'bg-sea text-onyx border-sage/30'
                : toast.type === 'error'
                ? 'bg-lava-900/40 text-onyx border-lava-500/30'
                : toast.type === 'warning'
                ? 'bg-deep text-onyx border-amber-500/30'
                : 'bg-deep text-onyx border-sea'
            }`}
          ...
          >
            ...
            <div className="flex-shrink-0">
              ...
              {toast.type === 'error' && (
                <svg className="w-5 h-5 text-lava-500" fill="currentColor" viewBox="0 0 20 20">
            ...
            <button
              ...
              className="flex-shrink-0 p-1 rounded hover:bg-onyx/10 transition-colors text-sage hover:text-onyx"
              aria-label="إغلاق"
            >
