    ...
    return (
        <div className={`flex flex-col items-center justify-center py-16 px-4 text-center rounded-2xl bg-cream border-2 border-dashed border-hairline animate-content-fade-in ${className}`}>
            <div className="relative mb-6 group">
                ...
                <div className="relative bg-copper-500/10 w-20 h-20 rounded-full flex items-center justify-center text-copper-700 ring-8 ring-cream transition-transform duration-500 group-hover:scale-110">
